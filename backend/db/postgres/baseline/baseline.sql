...
CREATE TABLE data.service_catalog (
    ...
    support_locations_raw text,
    request_process_raw text,
    support_availability_raw text,
    service_cost_raw text,
    additional_information_raw text,
    retired_note text,
    cp_service_type_raw character varying(255),
    service_features_raw text,
    ext_tools_raw text,
    legacy_ssl_mapping_raw text,
    ...
    service_area_raw text,
    is_stub boolean DEFAULT false NOT NULL,
    customer_type_json text,
    options_json text,
    notes_json text,
    training_refs_json text,
...
--
-- Name: COLUMN service_catalog.cp_service_type_raw; Type: COMMENT; Schema: data; Owner: -
--

COMMENT ON COLUMN data.service_catalog.cp_service_type_raw IS 'D1: Raw CSV "CP Service Type" value. "Retired" maps to service_status_code=retired, not service_type_code.';


--
-- Name: COLUMN service_catalog.is_available_status_ambiguous; Type: COMMENT; Schema: data; Owner: -
--

COMMENT ON COLUMN data.service_catalog.is_available_status_ambiguous IS 'D2: TRUE when "Not Available" was mapped to planned. Governance queue: WHERE is_available_status_ambiguous = TRUE.';


--
-- Name: COLUMN service_catalog.service_area_raw; Type: COMMENT; Schema: data; Owner: -
--

COMMENT ON COLUMN data.service_catalog.service_area_raw IS 'D3: Raw "Service Area" without FK. FK deferred; overlap with service_line/organizational_element is unresolved.';
