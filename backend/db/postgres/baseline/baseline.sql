...
--
-- Name: c3_entity_link; Type: TABLE; Schema: data; Owner: -
--

CREATE TABLE data.c3_entity_link (
    id bigint NOT NULL,
    link_kind character varying(40) NOT NULL,
    capability_uuid character varying(100),
    technology_interaction_id bigint,
    c3_application_id bigint,
    c3_data_object_id bigint,
    c3_tin_id bigint,
    c3_service_id bigint,
    link_role character varying(50),
    source_slot character varying(50),
    ref_value character varying(200),
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    created_by character varying(255),
    CONSTRAINT ck_c3_entity_link_shape CHECK (((((link_kind)::text = 'capability_application'::text) AND (capability_uuid IS NOT NULL) AND (c3_application_id IS NOT NULL)) OR (((link_kind)::text = 'capability_data_object'::text) AND (capability_uuid IS NOT NULL) AND (c3_data_object_id IS NOT NULL)) OR (((link_kind)::text = 'capability_tin'::text) AND (capability_uuid IS NOT NULL) AND (c3_tin_id IS NOT NULL)) OR (((link_kind)::text = 'capability_c3_service'::text) AND (capability_uuid IS NOT NULL) AND (c3_service_id IS NOT NULL)) OR (((link_kind)::text = 'tin_application'::text) AND (technology_interaction_id IS NOT NULL) AND (c3_application_id IS NOT NULL) AND (source_slot IS NOT NULL)) OR (((link_kind)::text = 'tin_data_object'::text) AND (technology_interaction_id IS NOT NULL) AND (c3_data_object_id IS NOT NULL) AND (source_slot IS NOT NULL)) OR (((link_kind)::text = 'tin_c3_service'::text) AND (technology_interaction_id IS NOT NULL) AND (c3_service_id IS NOT NULL) AND (source_slot IS NOT NULL))))
);


--
-- Name: TABLE c3_entity_link; Type: COMMENT; Schema: data; Owner: -
--

COMMENT ON TABLE data.c3_entity_link IS 'All links from a C3 capability or technology interaction to a C3 entity; link_kind matches the graph edge_kind.';


--
-- Name: c3_capability_application_link; Type: VIEW; Schema: data; Owner: -
--

CREATE VIEW data.c3_capability_application_link AS
 SELECT id,
    capability_uuid,
    c3_application_id,
    link_role,
    ...
    created_by,
    link_kind
   FROM data.c3_entity_link
  WHERE ((link_kind)::text = 'capability_application'::text)
...
--
-- Name: c3_capability_c3_service_link; Type: VIEW; Schema: data; Owner: -
--

CREATE VIEW data.c3_capability_c3_service_link AS
 SELECT id,
    capability_uuid,
    c3_service_id,
    link_role,
    ...
    link_kind
   FROM data.c3_entity_link
  WHERE ((link_kind)::text = 'capability_c3_service'::text)
  WITH CASCADED CHECK OPTION;


--
-- Name: c3_capability_data_object_link; Type: VIEW; Schema: data; Owner: -
--

CREATE VIEW data.c3_capability_data_object_link AS
 SELECT id,
    capability_uuid,
    c3_data_object_id,
    link_role,
    ...
    link_kind
   FROM data.c3_entity_link
  WHERE ((link_kind)::text = 'capability_data_object'::text)
  WITH CASCADED CHECK OPTION;


--
-- Name: c3_capability_tin_link; Type: VIEW; Schema: data; Owner: -
--

CREATE VIEW data.c3_capability_tin_link AS
 SELECT id,
    capability_uuid,
    c3_tin_id,
    link_role,
    ...
    link_kind
   FROM data.c3_entity_link
  WHERE ((link_kind)::text = 'capability_tin'::text)
  WITH CASCADED CHECK OPTION;
...
--
-- Name: c3_entity_link_id_seq; Type: SEQUENCE; Schema: data; Owner: -
--

ALTER TABLE data.c3_entity_link ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME data.c3_entity_link_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: c3_technology_interaction_application_link; Type: VIEW; Schema: data; Owner: -
--

CREATE VIEW data.c3_technology_interaction_application_link AS
 SELECT id,
    ...
    link_kind
   FROM data.c3_entity_link
  WHERE ((link_kind)::text = 'tin_application'::text)
  WITH CASCADED CHECK OPTION;


--
-- Name: c3_technology_interaction_data_object_link; Type: VIEW; Schema: data; Owner: -
--

CREATE VIEW data.c3_technology_interaction_data_object_link AS
 SELECT id,
    technology_interaction_id,
    c3_data_object_id,
    source_slot,
    ...
    link_kind
   FROM data.c3_entity_link
  WHERE ((link_kind)::text = 'tin_data_object'::text)
  WITH CASCADED CHECK OPTION;
...
--
-- Name: c3_technology_interaction_service_link; Type: VIEW; Schema: data; Owner: -
--

CREATE VIEW data.c3_technology_interaction_service_link AS
 SELECT id,
    technology_interaction_id,
    c3_service_id,
    source_slot,
    ...
    link_kind
   FROM data.c3_entity_link
  WHERE ((link_kind)::text = 'tin_c3_service'::text)
  WITH CASCADED CHECK OPTION;
...
CREATE TABLE data.graph_layout_audit (
    ...
    view_key character varying(120),
    node_id character varying(200)
);
...
--
-- Name: graph_node_layout; Type: TABLE; Schema: data; Owner: -
--

CREATE TABLE data.graph_node_layout (
    view_key character varying(120) NOT NULL,
...
--
-- Name: TABLE graph_node_layout; Type: COMMENT; Schema: data; Owner: -
--

COMMENT ON TABLE data.graph_node_layout IS 'Saved node positions per graph view (view_key) and graph node id (node_id).';
...
CREATE VIEW data.v_c3_entity_link AS
 SELECT l.link_kind,
    (
        CASE
            WHEN (l.capability_uuid IS NOT NULL) THEN 'capability'::text
            ELSE 'tin'::text
        END)::character varying(20) AS source_kind,
    COALESCE(l.capability_uuid, ti.uuid) AS source_uuid,
    l.technology_interaction_id AS source_id,
    (
        CASE
            WHEN (l.c3_application_id IS NOT NULL) THEN 'application'::text
            WHEN (l.c3_data_object_id IS NOT NULL) THEN 'data_object'::text
            WHEN (l.c3_tin_id IS NOT NULL) THEN 'tin'::text
            ELSE 'c3_service'::text
        END)::character varying(20) AS target_kind,
   ...
   FROM (((((data.c3_entity_link l
     LEFT JOIN data.c3_technology_interaction ti ON ((ti.id = l.technology_interaction_id)))
     LEFT JOIN data.c3_application app ON ((app.id = l.c3_application_id)))
     LEFT JOIN data.c3_data_object dob ON ((dob.id = l.c3_data_object_id)))
     LEFT JOIN data.c3_technology_interaction tin ON ((tin.id = l.c3_tin_id)))
     LEFT JOIN data.c3_service svc ON ((svc.id = l.c3_service_id)));
...
COMMENT ON VIEW data.v_c3_entity_link IS 'Read model over data.c3_entity_link with target entity details; link_kind matches graph edge_kind.';
...
CREATE VIEW data.v_servicepublishreadiness AS
 WITH active_flavours AS (
         ...
         SELECT sc_1.id AS service_id,
            ...
            sum(
                CASE
                    WHEN ((sr.relation_type_code)::text = ANY (ARRAY[('depends_on'::character varying)::text, ('prerequisite'::character varying)::text, ('underlying'::character varying)::text, ('requires_account'::character varying)::text, ('uses'::character varying)::text])) THEN 1
                    ELSE 0
...
--
-- Name: c3_capability_application_link link_kind; Type: DEFAULT; Schema: data; Owner: -
--

ALTER TABLE ONLY data.c3_capability_application_link ALTER COLUMN link_kind SET DEFAULT 'capability_application'::character varying;


--
-- Name: c3_capability_c3_service_link link_kind; Type: DEFAULT; Schema: data; Owner: -
--

ALTER TABLE ONLY data.c3_capability_c3_service_link ALTER COLUMN link_kind SET DEFAULT 'capability_c3_service'::character varying;


--
-- Name: c3_capability_data_object_link link_kind; Type: DEFAULT; Schema: data; Owner: -
--

ALTER TABLE ONLY data.c3_capability_data_object_link ALTER COLUMN link_kind SET DEFAULT 'capability_data_object'::character varying;


--
-- Name: c3_capability_tin_link link_kind; Type: DEFAULT; Schema: data; Owner: -
--

ALTER TABLE ONLY data.c3_capability_tin_link ALTER COLUMN link_kind SET DEFAULT 'capability_tin'::character varying;


--
-- Name: c3_technology_interaction_application_link link_kind; Type: DEFAULT; Schema: data; Owner: -
--

ALTER TABLE ONLY data.c3_technology_interaction_application_link ALTER COLUMN link_kind SET DEFAULT 'tin_application'::character varying;


--
-- Name: c3_technology_interaction_data_object_link link_kind; Type: DEFAULT; Schema: data; Owner: -
--

ALTER TABLE ONLY data.c3_technology_interaction_data_object_link ALTER COLUMN link_kind SET DEFAULT 'tin_data_object'::character varying;


--
-- Name: c3_technology_interaction_service_link link_kind; Type: DEFAULT; Schema: data; Owner: -
--

ALTER TABLE ONLY data.c3_technology_interaction_service_link ALTER COLUMN link_kind SET DEFAULT 'tin_c3_service'::character varying;
...
taxonomy_mapping_audit	data.taxonomy_mapping_audit	365	90	t	2000-01-01 00:00:00+00
graph_layout_audit	data.graph_layout_audit	365	90	t	2000-01-01 00:00:00+00
import_batch	data.import_batch	365	90	t	2000-01-01 00:00:00+00
import_row	data.import_row	180	60	t	2000-01-01 00:00:00+00
import_issue	data.import_issue	365	90	t	2000-01-01 00:00:00+00
\.
...
--
-- Data for Name: c3_entity_link; Type: TABLE DATA; Schema: data; Owner: -
--

COPY data.c3_entity_link (id, link_kind, capability_uuid, technology_interaction_id, c3_application_id, c3_data_object_id, c3_tin_id, c3_service_id, link_role, source_slot, ref_value, created_at, created_by) FROM stdin;
\.
...
COPY data.graph_layout_audit (id, service_id, node_kind, old_x, old_y, new_x, new_y, changed_by, changed_at, view_key, node_id) FROM stdin;
\.
...
--
-- Data for Name: graph_node_layout; Type: TABLE DATA; Schema: data; Owner: -
--

COPY data.graph_node_layout (view_key, node_id, x, y, updated_by, updated_at) FROM stdin;
\.
...
service_has_owner	Service has owner	A service needs an active owner assignment before it can be governed or published.	P0	t	t	\N	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00	Service has owner	A service needs an active owner assignment before it can be governed or published.	Assign an accountable service owner in the ownership section.	service_role_assignment.role_code=service_owner
service_has_offering	Service has offering or pricing evidence	A service needs at least one structured offering, active legacy flavour, pricing note, or pricing evidence.	P0	t	t	\N	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00	Service has offering or pricing evidence	A service needs at least one structured offering, active legacy flavour, pricing note, or pricing evidence.	Create at least one active offering or available flavour.	service_offering or active service_flavour
service_has_lifecycle_stage	Service has lifecycle state	A canonical lifecycle state is required for readiness and review queues.	P1	t	t	\N	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00	Service has lifecycle state	A canonical lifecycle state is required for readiness and review queues.	Set the service lifecycle stage and review whether the workflow state is correct.	service_catalog.lifecycle_stage_code
service_has_primary_capability_mapping	Service has primary capability mapping	A primary C3 or capability mapping is required for capability coverage governance.	P1	t	t	\N	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00	Service has primary capability mapping	A primary C3 or capability mapping is required for capability coverage governance.	Map exactly one primary C3 capability to the service.	service_c3_mapping.is_primary=true
service_has_sla	Service has SLA	Availability, restoration, delivery target, or SLA record is required.	P1	t	t	\N	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00	Service has SLA	Availability, restoration, delivery target, or SLA record is required.	Add SLA commitments or an explicit support model exception.	service_catalog SLA fields or service_sla records
service_has_dependency_classification	Service has dependency classification	Dependencies should be classified so change and readiness impact can be assessed.	P2	f	f	\N	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00	Service has dependency classification	Dependencies should be classified so change and readiness impact can be assessed.	Classify dependencies and mark mandatory or operationally critical relationships.	service_relation dependency kinds
service_has_review_date	Service has review date	Review due date keeps ownership and readiness decisions current.	P2	f	f	\N	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00	Service has review date	Review due date keeps ownership and readiness decisions current.	Set the next review date or governance owner.	review_due_at or next_review_due_at
requestable_service_has_pricing	Requestable service has pricing	Requestable services should have pricing, cost note, or an explicit exception.	P2	f	f	\N	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00	Requestable service has pricing	Requestable services should have pricing, cost note, or an explicit exception.	Add a price, rate note or approved pricing exception.	service_flavour.price_value or pricing note
\.
...
1	application service	Application Services	seed	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
2	application services	Application Services	seed	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
3	infrastructure service	Infrastructure Services	seed	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
4	infrastructure services	Infrastructure Services	seed	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
5	platform service	Platform Services	seed	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
6	platform services	Platform Services	seed	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
7	platform service s	Platform Services	seed	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
8	security service	Security Services	seed	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
9	security services	Security Services	seed	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
10	network service	Network Services	seed	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
11	network services	Network Services	seed	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
12	workplace service	Workplace Services	seed	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
13	workplace services	Workplace Services	seed	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
14	subject matter expertise service	Subject Matter Expertise Services	seed	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
15	subject matter expertise services	Subject Matter Expertise Services	seed	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
16	training service	Training Services	seed	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
17	training services	Training Services	seed	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
18	logistic service	Logistic Services	seed	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
19	logistic services	Logistic Services	seed	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
20	other service	Other Services	seed	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
21	other services	Other Services	seed	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
22	digital workplace service	Digital Workplace Services	seed	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
23	digital workplace services	Digital Workplace Services	seed	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
\.
...
2	Spiral_4	Spiral 4	f	Historical FMN spiral baseline; inactive until explicitly enabled.	\N	\N	2000-01-01 00:00:00+00
3	Spiral_5	Spiral 5	f	FMN Spiral 5 baseline used by Air C2 PDF parity work.	\N	\N	2000-01-01 00:00:00+00
4	Spiral_7	Spiral 7	f	Future/imported FMN spiral baseline.	\N	\N	2000-01-01 00:00:00+00
1	Spiral_6	Spiral 6 (current baseline)	t	Current active baseline for existing C3 seed data.	2000-01-01 00:00:00+00	\N	2000-01-01 00:00:00+00
\.
...
1	Workplace Services	Workplace Services	\N	active	\N	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
2	Application Services	Application Services	\N	active	\N	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
3	Infrastructure Services	Infrastructure Services	\N	active	\N	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
4	Platform Services	Platform Services	\N	active	\N	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
5	Security Services	Security Services	\N	active	\N	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
6	Network Services	Network Services	\N	active	\N	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
7	Logistic Services	Logistic Services	\N	active	\N	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
8	Other Services	Other Services	\N	active	\N	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
9	Digital Workplace Services	Digital Workplace Services	\N	active	\N	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
10	Subject Matter Expertise Services	Subject Matter Expertise Services	\N	active	\N	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
11	Training Services	Training Services	\N	active	\N	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
\.
...
1	catalog.model.version	v2.1-graph-pricing-sla-taxonomy	string	Canonical model version	f	2000-01-01 00:00:00+00	\N
2	import.parser.version	1	number	Current CSV import parser version	f	2000-01-01 00:00:00+00	\N
3	import.store_raw_fields	true	boolean	Store raw source fields for audit and re-parse	f	2000-01-01 00:00:00+00	\N
4	graph.default_relation_confidence	1.0	number	Default confidence for explicit relations	f	2000-01-01 00:00:00+00	\N
5	app.version	1.2	string	Application version	f	2000-01-01 00:00:00+00	\N
6	app.default_lang	cs	string	Default UI language (cs / en)	f	2000-01-01 00:00:00+00	\N
7	app.default_theme	dark	string	Default UI theme (dark / light)	f	2000-01-01 00:00:00+00	\N
8	auth.jwt_expiry_minutes	60	number	Access token lifetime in minutes	f	2000-01-01 00:00:00+00	\N
9	auth.refresh_expiry_days	7	number	Refresh token lifetime in days	f	2000-01-01 00:00:00+00	\N
10	auth.sso.enabled	false	boolean	Enable trusted-header SSO login.	f	2000-01-01 00:00:00+00	\N
11	auth.sso.header	x-remote-user	string	Trusted header carrying the authenticated AD identity.	f	2000-01-01 00:00:00+00	\N
12	auth.sso.display_name_header	x-remote-name	string	Trusted header carrying the display name.	f	2000-01-01 00:00:00+00	\N
13	auth.sso.email_header	x-remote-email	string	Trusted header carrying the email address.	f	2000-01-01 00:00:00+00	\N
14	auth.sso.given_name_header	x-remote-given-name	string	Trusted header carrying the given name.	f	2000-01-01 00:00:00+00	\N
15	auth.sso.surname_header	x-remote-surname	string	Trusted header carrying the surname.	f	2000-01-01 00:00:00+00	\N
16	auth.sso.department_header	x-remote-department	string	Trusted header carrying the department.	f	2000-01-01 00:00:00+00	\N
17	c3.sync_enabled	false	boolean	Enable automatic C3 Taxonomy synchronization	f	2000-01-01 00:00:00+00	\N
18	c3.sync_interval_hours	24	number	C3 synchronization interval in hours	f	2000-01-01 00:00:00+00	\N
19	cache.dashboard_ttl_sec	300	number	Dashboard statistics cache TTL in seconds	f	2000-01-01 00:00:00+00	\N
\.
...
1	administrators	Administrators	Full access to all columns and ref data	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
\.
...
1	c3.list	c3	/c3/list	["/admin/c3"]	page	/api/v1/export/taxonomy	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
2	c3.dashboard	c3	/c3/dashboard	["/admin/c3/dashboard"]	page	/api/v1/export/taxonomy	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
3	c3.capability_map	c3	/c3/capability-map	["/c3-dashboard"]	page	/api/v1/export/capability-map-hierarchy	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
4	c3.detail	c3	/c3/{uuid}	["/admin/c3/{uuid}"]	page	/api/v1/export/capability-map-hierarchy	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
5	c3.graph	c3	/c3/graph	["/admin/c3/graph"]	page	/api/v1/export/c3-relationships	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
6	services.list	service	/services/list	["/"]	page	\N	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
7	services.dashboard	service	/services/dashboard	\N	page	\N	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
8	services.graph	service	/services/graph	\N	page	/api/v1/export/graph-overview	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
9	pricing.ui	pricing	/services/{id}/edit#flavours	\N	page	/api/v1/export/pricing	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
10	sla.ui	sla	/services/{id}/edit#sla	\N	page	/api/v1/export/sla	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
11	export.taxonomy	export	/api/v1/export/taxonomy	\N	api	/api/v1/export/taxonomy	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
12	export.graph	export	/api/v1/export/graph-overview	\N	api	/api/v1/export/graph-overview	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
13	export.pricing	export	/api/v1/export/pricing	\N	api	/api/v1/export/pricing	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
14	export.sla	export	/api/v1/export/sla	\N	api	/api/v1/export/sla	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
15	export.bundle	export	/api/v1/export/bundle	\N	api	/api/v1/export/bundle	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
16	export.manifest	export	/api/v1/export/manifest	\N	api	/api/v1/export/manifest	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
17	export.c3_relationships	export	/api/v1/export/c3-relationships	\N	api	/api/v1/export/c3-relationships	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
18	export.capability_map	export	/api/v1/export/capability-map-hierarchy	\N	api	/api/v1/export/capability-map-hierarchy	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
19	import.review	import	/import	\N	page	/api/v1/export/bundle	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
20	import.admin_review	import	/admin/import	\N	page	/api/v1/export/bundle	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
21	import.upload	import	/import/upload	\N	page	/api/v1/export/bundle	t	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
\.
...
service_catalog_bundle	2026-03-30.c3-v3	canonical-23	365	90	Service graph + pricing + SLA + taxonomy + import/audit exports	2000-01-01 00:00:00+00
\.
...
1	DATABASE_LAYER	Database Layer	t	f	f	f	f	f	f	1.0.0	0	\N	\N	\N	2000-01-01 00:00:00+00
2	PLATFORM_CORE	Platform Core	t	f	f	f	f	f	f	1.0.0	1	\N	\N	\N	2000-01-01 00:00:00+00
3	SERVICE_CATALOGUE_CORE	Service Catalogue	t	f	f	f	f	f	f	1.0.0	2	\N	\N	\N	2000-01-01 00:00:00+00
4	C3_TAXONOMY	C3 Capability Taxonomy	f	f	f	f	f	f	f	1.0.0	3	\N	\N	\N	2000-01-01 00:00:00+00
5	MANAGEMENT	Management Cockpit	t	f	f	f	f	f	f	1.0.0	4	\N	\N	\N	2000-01-01 00:00:00+00
\.
...
1	1.0.0	1.0.0	Initial release — Service Catalogue v2.1	\N	2000-01-01 00:00:00+00	init	t	\N	\N
\.
...
1	00_bootstrap	Bootstrap — schemas + extensions	1.0.0	\N	2000-01-01 00:00:00+00	init	\N	\N	\N	\N
2	01_platform	Platform — AppConfig, Users, RefreshTokens, AuditLog	1.0.0	\N	2000-01-01 00:00:00+00	init	\N	\N	\N	\N
3	02_ref	Reference data — lookup tables	1.0.0	\N	2000-01-01 00:00:00+00	init	\N	\N	\N	\N
4	03_groups	Groups — AppGroup, AppGroupPermission	1.0.0	\N	2000-01-01 00:00:00+00	init	\N	\N	\N	\N
5	04_core	Core — ServiceCatalog main table	1.0.0	\N	2000-01-01 00:00:00+00	init	\N	\N	\N	\N
6	05_graph	Graph — ServiceRelation, ServiceRelationRaw	1.0.0	\N	2000-01-01 00:00:00+00	init	\N	\N	\N	\N
7	06_pricing	Pricing — ServiceFlavour, ServiceSla	1.0.0	\N	2000-01-01 00:00:00+00	init	\N	\N	\N	\N
8	07_domains	Domains — ServiceAvailableOn M:N	1.0.0	\N	2000-01-01 00:00:00+00	init	\N	\N	\N	\N
9	08_ownership	Ownership — ServiceRoleAssignment, ServiceC3Mapping	1.0.0	\N	2000-01-01 00:00:00+00	init	\N	\N	\N	\N
10	09_import	Import — ImportBatch, ImportRow, ImportIssue	1.0.0	\N	2000-01-01 00:00:00+00	init	\N	\N	\N	\N
11	10_indexes	Indexes — performance indexes	1.0.0	\N	2000-01-01 00:00:00+00	init	\N	\N	\N	\N
12	11_c3	C3 — taxonomy, entities, links, builder	1.0.0	\N	2000-01-01 00:00:00+00	init	\N	\N	\N	\N
13	12_exports_retention	Exports + retention — views, archive	1.0.0	\N	2000-01-01 00:00:00+00	init	\N	\N	\N	\N
14	13_install_system	Install system — state machine, migrations, modules	1.0.0	\N	2000-01-01 00:00:00+00	init	\N	\N	\N	\N
15	14_spiral_versioning	FMN Spiral versioning — fmn_spiral columns on C3 entity tables, Spiral_4/5/7 seed	2.1.0	\N	2000-01-01 00:00:00+00	\N	\N	\N	\N	fmn_spiral VARCHAR(20) added to c3_taxonomy, c3_application, c3_data_object, c3_service, c3_technology_interaction, c3_capability_builder; Spiral_4/5/7 seeded into ref_spiral_baseline
16	15_itil_catalogue_phase1	ITIL-ready catalogue Phase 1 — service offerings, support model, audience policy, operational links	2.2.0	\N	2000-01-01 00:00:00+00	\N	\N	\N	\N	Adds additive service-level metadata to data.service_catalog plus data.service_offering, data.service_support_model, data.service_audience_policy, and data.service_operational_link
17	16_consumer_value	Consumer value additive column	2.2.1	\N	2000-01-01 00:00:00+00	\N	\N	\N	\N	Adds additive consumer_value field to data.service_catalog
18	17_spiral_membership	C3 entity multi-spiral membership	2.1.3	\N	2000-01-01 00:00:00+00	\N	\N	\N	\N	Adds c3_entity_spiral_membership, backfills existing C3 entities, seeds Spiral_4/5, and exposes v_c3_entity_membership_matrix.
19	18_user_persona	Persona preference for user-driven UX lenses	2.2.0	\N	2000-01-01 00:00:00+00	\N	\N	\N	\N	Adds preferred_persona to platform.users for Consumer, Service Owner, Capability Manager, and Administrator journeys
20	19_capability_abbreviations	Capability abbreviations for stable Level-3 slugs	2.2.0	\N	2000-01-01 00:00:00+00	\N	\N	\N	\N	Populates C3 capability abbreviations for L1/L2/L3 URL slugs
21	20_capability_coverage_views	Generic capability coverage helper views	2.2.0	\N	2000-01-01 00:00:00+00	\N	\N	\N	\N	Adds SQL views for capability requirements, coverage, completeness, evidence, and overlap API support
22	21_contract_governance	Contract governance foundation	2.3.0	\N	2000-01-01 00:00:00+00	\N	\N	\N	\N	Adds vendor, contract, contract-to-service/capability links, and governance finding dismissal audit tables
23	22_governance_views	Governance radar and advisor views	2.3.0	\N	2000-01-01 00:00:00+00	\N	\N	\N	\N	Adds service risk radar, owner load, contract overlap, renewal risk, and gap/duplication advisor views
24	23_service_portfolio	Service portfolio and governance metadata foundation	2.3.0	\N	2000-01-01 00:00:00+00	\N	\N	\N	\N	Adds service portfolios, lifecycle stage reference values, criticality reference values, and service-level portfolio/review metadata
25	24_readiness_rules	Configurable readiness rules	2.4.0	\N	2000-01-01 00:00:00+00	\N	\N	\N	\N	Adds readiness rules and auditable service-level exceptions
26	25_capability_governance	Capability governance coverage cockpit	2.5.0	\N	2000-01-01 00:00:00+00	\N	\N	\N	\N	Adds normalized capability mapping roles and coverage/gap/overlap governance views
27	26_governance_workflow	Governance workflow reviews and decisions	2.6.0	\N	2000-01-01 00:00:00+00	\N	\N	\N	\N	Adds governance reviews, decision log, statuses, and service-linked workflow history
28	27_impact_analysis	Impact analysis helper views and relation kinds	1.2.0	\N	2000-01-01 00:00:00+00	\N	\N	\N	\N	Adds normalized impact nodes and edges for service/capability traversal.
29	29_reduction_low_risk_cleanup	Reduction low-risk cleanup	2.9.0	\N	2000-01-01 00:00:00+00	\N	\N	\N	\N	Drops retired notification/request/preference objects, preferred_persona, and orphan archive export views.
30	30_reduction_domain_model_simplification	Reduction stage 10 domain model simplification	3.0.0	\N	2000-01-01 00:00:00+00	\N	\N	\N	\N	Keeps historical lifecycle/status and decision data; reduces active readiness rules to five core user-fixable rules
31	31_locale_cs_en_only	Reduce supported UI locales to Czech and English	2.2.0-reduction	\N	2000-01-01 00:00:00+00	\N	\N	\N	\N	Migrates sk/de/legacy locale preferences to the canonical cs/en product decision and enforces the new allowed set.
32	32_final_reduction_sunset_cleanup	Final v1.2 reduction sunset cleanup	2.8.0	\N	2000-01-01 00:00:00+00	\N	\N	\N	\N	Removes retired risk/advisor/procurement DB objects and keeps owner load as a service/readiness/C3 view
33	33_readiness_rule_explanations	Readiness rule explanations	3.1.0	\N	2000-01-01 00:00:00+00	\N	\N	\N	\N	Adds why/how-to/evidence explanation texts to readiness rules (split from 28).
34	34_c3_board_state	C3 governance board state	3.1.0	\N	2000-01-01 00:00:00+00	\N	\N	\N	\N	Adds c3_board_state and v_c3_board_lane (split from 28).
35	35_canonical_service_fields	Canonical service lifecycle, review date and portfolio	3.2.0	\N	2000-01-01 00:00:00+00	\N	\N	\N	\N	Makes lifecycle_stage_code, review_due_at and portfolio_id canonical; legacy mirrors kept in sync by trigger; v_owner_load reads canonical fields.
36	36_service_sla_canonical	Canonical service-level SLA in service_sla	3.3.0	\N	2000-01-01 00:00:00+00	\N	\N	\N	\N	Primary service-level service_sla row is canonical; service_catalog sla_* columns are a trigger-synced mirror.
37	37_offering_request_inheritance	Offering request fields inherit from the service	3.4.0	\N	2000-01-01 00:00:00+00	\N	\N	\N	\N	Offering requestable/approval/channel/lead time: NULL inherits the service value; v_service_offering_effective resolves effective values.
38	38_c3_entity_link_view	Unified C3 entity link read model	3.5.0	\N	2000-01-01 00:00:00+00	\N	\N	\N	\N	Adds v_c3_entity_link over the seven C3 capability/technology-interaction link tables.
39	39_drop_legacy_service_mirrors	Drop legacy service mirror columns	3.6.0	\N	2000-01-01 00:00:00+00	\N	\N	\N	\N	Removes lifecycle_state, service_status_code, next_review_due_at, portfolio_group_code and catalogue sla_* columns; views read canonical fields.
40	40_service_catalog_source	Service catalogue import provenance table and merged description fields	3.7.0	\N	2000-01-01 00:00:00+00	\N	\N	\N	\N	Moves import raw/source columns to data.service_catalog_source; merges value_proposition/business_purpose into consumer_value and business_summary into short_description/description.
41	41_graph_node_layout	Per-view graph node layout	3.8.0	\N	2000-01-01 00:00:00+00	\N	\N	\N	\N	Adds data.graph_node_layout (view_key, node_id); moves service_catalog.graph_x/graph_y to the service-overview/portfolio view.
42	42_c3_entity_link_table	C3 link tables merged into c3_entity_link	3.9.0	\N	2000-01-01 00:00:00+00	\N	\N	\N	\N	Moves the seven C3 capability/technology-interaction link tables into data.c3_entity_link; the old names are updatable compatibility views.
\.
...
1	NOT_INSTALLED	\N	f	\N	\N	\N	\N	\N	\N	\N	\N	\N	2000-01-01 00:00:00+00	2000-01-01 00:00:00+00
\.
...
--
-- Name: c3_entity_link_id_seq; Type: SEQUENCE SET; Schema: data; Owner: -
--

SELECT pg_catalog.setval('data.c3_entity_link_id_seq', 1, false);
...
SELECT pg_catalog.setval('platform.schema_migrations_id_seq', 42, true);
...
--
-- Name: c3_entity_link c3_entity_link_pkey; Type: CONSTRAINT; Schema: data; Owner: -
--

ALTER TABLE ONLY data.c3_entity_link
    ADD CONSTRAINT c3_entity_link_pkey PRIMARY KEY (id);
...
--
-- Name: graph_node_layout graph_node_layout_pkey; Type: CONSTRAINT; Schema: data; Owner: -
--

ALTER TABLE ONLY data.graph_node_layout
    ADD CONSTRAINT graph_node_layout_pkey PRIMARY KEY (view_key, node_id);
...
--
-- Name: ix_c3_entity_link_application; Type: INDEX; Schema: data; Owner: -
--

CREATE INDEX ix_c3_entity_link_application ON data.c3_entity_link USING btree (c3_application_id) WHERE (c3_application_id IS NOT NULL);


--
-- Name: ix_c3_entity_link_data_object; Type: INDEX; Schema: data; Owner: -
--

CREATE INDEX ix_c3_entity_link_data_object ON data.c3_entity_link USING btree (c3_data_object_id) WHERE (c3_data_object_id IS NOT NULL);


--
-- Name: ix_c3_entity_link_kind_capability; Type: INDEX; Schema: data; Owner: -
--

CREATE INDEX ix_c3_entity_link_kind_capability ON data.c3_entity_link USING btree (link_kind, capability_uuid);


--
-- Name: ix_c3_entity_link_kind_ti; Type: INDEX; Schema: data; Owner: -
--

CREATE INDEX ix_c3_entity_link_kind_ti ON data.c3_entity_link USING btree (link_kind, technology_interaction_id, source_slot);


--
-- Name: ix_c3_entity_link_service; Type: INDEX; Schema: data; Owner: -
--

CREATE INDEX ix_c3_entity_link_service ON data.c3_entity_link USING btree (c3_service_id) WHERE (c3_service_id IS NOT NULL);


--
-- Name: ix_c3_entity_link_tin; Type: INDEX; Schema: data; Owner: -
--

CREATE INDEX ix_c3_entity_link_tin ON data.c3_entity_link USING btree (c3_tin_id) WHERE (c3_tin_id IS NOT NULL);
...
--
-- Name: uq_c3_entity_link_cap_app; Type: INDEX; Schema: data; Owner: -
--

CREATE UNIQUE INDEX uq_c3_entity_link_cap_app ON data.c3_entity_link USING btree (capability_uuid, c3_application_id) WHERE ((link_kind)::text = 'capability_application'::text);


--
-- Name: uq_c3_entity_link_cap_do; Type: INDEX; Schema: data; Owner: -
--

CREATE UNIQUE INDEX uq_c3_entity_link_cap_do ON data.c3_entity_link USING btree (capability_uuid, c3_data_object_id) WHERE ((link_kind)::text = 'capability_data_object'::text);


--
-- Name: uq_c3_entity_link_cap_svc; Type: INDEX; Schema: data; Owner: -
--

CREATE UNIQUE INDEX uq_c3_entity_link_cap_svc ON data.c3_entity_link USING btree (capability_uuid, c3_service_id) WHERE ((link_kind)::text = 'capability_c3_service'::text);


--
-- Name: uq_c3_entity_link_cap_tin; Type: INDEX; Schema: data; Owner: -
--

CREATE UNIQUE INDEX uq_c3_entity_link_cap_tin ON data.c3_entity_link USING btree (capability_uuid, c3_tin_id) WHERE ((link_kind)::text = 'capability_tin'::text);
...
--
-- Name: c3_entity_link c3_entity_link_c3_application_id_fkey; Type: FK CONSTRAINT; Schema: data; Owner: -
--

ALTER TABLE ONLY data.c3_entity_link
    ADD CONSTRAINT c3_entity_link_c3_application_id_fkey FOREIGN KEY (c3_application_id) REFERENCES data.c3_application(id) ON DELETE CASCADE;


--
-- Name: c3_entity_link c3_entity_link_c3_data_object_id_fkey; Type: FK CONSTRAINT; Schema: data; Owner: -
--

ALTER TABLE ONLY data.c3_entity_link
    ADD CONSTRAINT c3_entity_link_c3_data_object_id_fkey FOREIGN KEY (c3_data_object_id) REFERENCES data.c3_data_object(id) ON DELETE CASCADE;


--
-- Name: c3_entity_link c3_entity_link_c3_service_id_fkey; Type: FK CONSTRAINT; Schema: data; Owner: -
--

ALTER TABLE ONLY data.c3_entity_link
    ADD CONSTRAINT c3_entity_link_c3_service_id_fkey FOREIGN KEY (c3_service_id) REFERENCES data.c3_service(id) ON DELETE CASCADE;


--
-- Name: c3_entity_link c3_entity_link_c3_tin_id_fkey; Type: FK CONSTRAINT; Schema: data; Owner: -
--

ALTER TABLE ONLY data.c3_entity_link
    ADD CONSTRAINT c3_entity_link_c3_tin_id_fkey FOREIGN KEY (c3_tin_id) REFERENCES data.c3_technology_interaction(id) ON DELETE CASCADE;


--
-- Name: c3_entity_link c3_entity_link_capability_uuid_fkey; Type: FK CONSTRAINT; Schema: data; Owner: -
--

ALTER TABLE ONLY data.c3_entity_link
    ADD CONSTRAINT c3_entity_link_capability_uuid_fkey FOREIGN KEY (capability_uuid) REFERENCES data.c3_taxonomy(uuid) ON DELETE CASCADE;


--
-- Name: c3_entity_link c3_entity_link_technology_interaction_id_fkey; Type: FK CONSTRAINT; Schema: data; Owner: -
--

ALTER TABLE ONLY data.c3_entity_link
    ADD CONSTRAINT c3_entity_link_technology_interaction_id_fkey FOREIGN KEY (technology_interaction_id) REFERENCES data.c3_technology_interaction(id) ON DELETE CASCADE;
