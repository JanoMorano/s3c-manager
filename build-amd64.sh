...
#   - sc-images-amd64-1.1.1.tar
#   - sc-qnap-bundle-amd64-1.1.1.tar.gz
#
# Usage:
...
# Reads the default value of APP_VERSION, e.g.: APP_VERSION: ${APP_VERSION:-1.1.1}
DETECTED_VERSION=""
...
if [ "$DO_RELEASE" = true ]; then
  # Git tag uses the plain version (with optional leading v), e.g. v1.1.1
  # The image tag has the arch suffix (sc-app:1.1.1-amd64) but the release tag does not.
  GIT_TAG="${IMAGE_TAG}"
